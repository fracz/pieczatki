        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
            <a href="/" class="navbar-brand">
                <h1 class="m-0 text-primary">
                    <span class="text-dark">PIECZĄTKI</span>
                    TURYSTYCZNE
                </h1>
            </a>
...
<div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
    <div class="row pt-5">
        ...
        <div class="col-lg-12">
            <a href="" class="navbar-brand">
                <h1 class="text-primary text-wrap">
                    <span class="text-white">POLSKIE</span>
                    PIECZĄTKI
                    <span class="text-white">TURYSTYCZNE</span>
                </h1>
            </a>
...
<div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5"
    ...
    <div class="row">
        <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
            <p class="m-0 text-white-50">Copyright &copy; <a href="#">pieczatkiturystyczne.pl</a>. All Rights
                Reserved.</a>
            </p>
        </div>
